import { SignUpSchema } from "@vipinyadav2k/medium-common";
      ...
      <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    {type === "signup" ? <LabelledInput label="Name" placeholder="Vipin Yadav..." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} /> : null}
                    <LabelledInput label="Username" placeholder="vipin@gmail.com" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
